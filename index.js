...
var incorrect = clc.redBright;

//Pre-defined color for correct guess.
var correct = clc.greenBright;
...
var wordList = ["AnakinSkywalker", "HanSolo", "DarthMaul", "KyloRen", "PrincessLeia", "LukeSkywalker", "Chewbacca", "ObiWanKenobi", "JarJarBinks", "JabbaTheHutt", "DarthVader", "TheEmperor"];
...
figlet("NODE HANGMAN", function(err, data) {
    ...
    console.log(data)
    //Welcome screen text.
    console.log(gameTextColor("Welcome to the JS node version of the classic Hangman Game!"));
    console.log(gameTextColor("Theme is... Star Wars Characters Edition."));
    //Game instructions.
    var howToPlay = 
    "==========================================================================================================" + "\r\n" +
    "How to play" + "\r\n" +
...
function checkIfUserWon() {
	...
	if (guessesRemaining === 0) {
		...
		console.log(gameTextColor("The correct STAR WARS character was: " + randomWord));
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU'RE A TRUE STAR WARS FAN!"));
